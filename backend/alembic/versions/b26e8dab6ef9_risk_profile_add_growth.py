...
def downgrade() -> None:
    ...
    # RISK_PROFILE_CYCLE), yani bu satırların var olması BEKLENEN durumdur;
    # downgrade'in "hiç yok" varsayımıyla çalışması bir hata olurdu.
    #
    ...
    # öneri ürettirirdi. Geri alınamaz: upgrade tekrar çalıştırıldığında bu
